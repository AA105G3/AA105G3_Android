...
public class CollectionDetailRecipeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("我的收藏-食譜內容");
        setSupportActionBar(toolbar);
//        Log.d(TAG, "RecipeMainActivity  62");
...
//        TextView recipe_viewpage_recipe_cond_recipe_no = (TextView) findViewById(R.id.recipe_viewpage_recipe_cond_recipe_no);
...
//            Log.d(TAG, "getMem_name(line 235):" + memberVO.getMem_name());
...
//            Log.d(TAG, "recipeVO: 64" + recipeVO.getRecipe_no());
//            }
//            Log.d(TAG, "getMem_name(line 237):" + memberVO.getMem_name());
...
//            savedTabsFragment.setArguments(bundle);
...
//            pageList.add(new Page(new FilmFragment(), "影片"));
//            pageList.add(new Page(frd_listFragment, "步驟"));
//            pageList.add(new Page(collectionFragment, "討論"));
//
//            pageList.add(new Page(new RecipeFragment(), "食譜"));
//            pageList.add(new Page(new EssayFragment(), "文章"));
//            pageList.add(new Page(new FilmFragment(), "影片"));
//            pageList.add(new Page(new Frd_listFragment(), "好友"));
//            pageList.add(new Page(new QQQTest(), "訂單"));
//            pageList.add(new Page(new CollectionFragment(), "我的最愛"));
